# PROJECT-detail.md — Skill 253: fighting-game-combo-optimizer

## Executive Summary

`fighting-game-combo-optimizer` is a professional-grade harness for Claude Code targeting the
**Fighting-Game Combo & Frame-Data Optimization** domain. It transforms Claude into a domain-expert that delivers
...
|------|----------------|----------------|
| Practitioner | "Analyze Fighting-Game Combo & Frame-Data Optimization case X" | Full evidenced report |
...
[main.md — fighting-game-combo-optimizer]
    ...
    ├─► sub-core-analysis.md  → Analyze and propose optimal combo coordination for fighting games, optimizing damage, meter, and punish routes from frame data.
...
- **Role:** intake specialist for a Fighting-Game Combo & Frame-Data Optimization engagement
...
- **Role:** Fighting-Game Combo & Frame-Data Optimization data librarian
...
- **Purpose:** Analyze and propose optimal combo coordination for fighting games, optimizing damage, meter, and punish routes from frame data.
- **Role:** fighting-game combo & frame-data analyst
- **Inputs:** Game, character, situation, meter, available frame data.
- **Outputs:** Frame analysis + combo routes + punish routes + meter/okizeme + scenarios.
- **Tools:** - Read (SECOND-KNOWLEDGE-BRAIN.md)
- WebFetch (frame-data databases)
- Arithmetic / damage scaling
- **Quality Gate:** Frame advantage computed; combo routes optimized for damage/meter; punish routes from frame data; execution tradeoff noted.
...
- **Role:** research librarian for Fighting-Game Combo & Frame-Data Optimization
...
- **Role:** senior Fighting-Game Combo & Frame-Data Optimization advisor
...
- **Quality Gate:** Conclusion is exactly one of: Optimal Combo Plan / Conditional (execution risk) / Suboptimal Routes / Inconclusive; disclosure appears before the conclusion.
...
```
1. User invokes /fighting-game-combo-optimizer [query]
...
> Tạo skill phân tích và đề xuất chiến thuật phối hợp kỹ năng (Combo) tối ưu cho các tựa game đối kháng (Fighting Games), việc đánh giá và đưa đề xuất phải dựa trên các phương pháp đánh giá uy tín trên thế giới và đưa ra các đề xuất, giải pháp cải tiến, không ngừng đi crawl data từ các khung dữ liệu khung hình (Frame Data) của nhân vật hoặc document uy tín liên quan để cập nhật kiến thức cho skill ngày càng tốt hơn, xu hướng hơn.
