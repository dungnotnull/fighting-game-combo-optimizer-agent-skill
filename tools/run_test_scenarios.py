"""
run_test_scenarios.py â€” Skill 253: fighting-game-combo-optimizer
...
SKILLS = ROOT / "skills"
GATES = ["U1","U2","U3","U4","U5","U6"] + [g["id"] for g in [{"id": "G1", "check": "Frame advantage computed", "fix": "Compute frame advantage"}, {"id": "G2", "check": "Combo routes optimized for damage/meter", "fix": "Optimize combos"}, {"id": "G3", "check": "Punish routes from frame data", "fix": "Add punish routes"}, {"id": "G4", "check": "Execution difficulty vs consistency tradeoff noted", "fix": "Note execution tradeoff"}]]
VERDICTS = ["Optimal Combo Plan", "Conditional (execution risk)", "Suboptimal Routes", "Inconclusive"]
