"""
knowledge_updater.py — Skill 253: fighting-game-combo-optimizer
...
KNOWLEDGE_CONFIG = {
    "domain": "Fighting-Game Combo & Frame-Data Optimization",
    "keywords": [
        "fighting game combo optimization",
        "frame data advantage",
        "damage scaling combo",
        "meter management fighting",
        "punish optimization block",
        "okizeme pressure fighting"
    ],
    "arxiv_categories": [],
