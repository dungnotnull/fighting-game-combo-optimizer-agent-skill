# test-scenarios.md — Skill 253: fighting-game-combo-optimizer
...
- **Input:** a typical Fighting-Game Combo & Frame-Data Optimization case with complete inputs.
...
- **Verdict target:** Optimal Combo Plan.
...
### Verdict coverage
Optimal Combo Plan, Conditional (execution risk), Suboptimal Routes, Inconclusive.
